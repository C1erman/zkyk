...
const CustomForm = () => {
    ...
    return (
        <>
            <View className='question-edit-noti'>
                <View>您当前正在预览采样管编号为<Text className='question-edit-noti-barcode'>{editData.barcode}</Text>
                的绑定信息，受测人编码为<Text className='question-edit-noti-testeeCode'>{editData.code}</Text>
                ，此份信息的送样时间为<Text className='question-edit-noti-time'>{editData.date_of_collection}</Text>。</View>
            </View>
            <Title text='个人信息' />
            ...
            <Picker mode='date' onChange={e => handleSetPickerValue(e, 'date')} end={getNow()}>
                <AtList>
            ...
            <Title text='既往情况' />
            <View>
                <Text className='question-edit-label'>您是否被以下口腔问题所困扰：</Text>
            ...
            <View>
                <Text className='question-edit-label'>您通常一天刷牙的次数：</Text>
            ...
            <View>
                <Text className='question-edit-label'>饮食习惯：</Text>
            ...
            <View>
                <Text className='question-edit-label'>频率较高的生活习惯：</Text>
            ...
            <View>
                <Text className='question-edit-label'>您是否喜欢睡前进食：</Text>
            ...
            <View>
                <Text className='question-edit-label'>是否有熬夜、昼夜颠倒等习惯：</Text>
                <CustomRadio name='stayUp' radio={radio.stayUp} handleUpdateValue={result => handleValueChange(result, 'stayUp')} />
            </View>
            <View>
                <Text className='question-edit-label'>近一个月抗生素使用：</Text>
            ...
            <View>
                <Text className='question-edit-label'>近一个月是否服用过益生菌：</Text>
            ...
            <View>
                <Text className='question-edit-label'>近一个月是否服用过药物：</Text>
                <CustomRadio name='drug' radio={radio.drug} descrition='have' handleUpdateValue={result => handleValueChange(result, 'drug')} />
            </View>
            <AtButton loading={submiting} className='question-edit-button' customStyle={{ margin: '1rem 0' }} circle type='primary' onClick={handleSubmitForm}>修改问卷信息</AtButton>
        </>
    );
}
...
export default () => {
    return (
        <>
            <AtMessage />
            <View className='question-edit-container'>
                <CustomForm />
            </View>
        </>
    );
